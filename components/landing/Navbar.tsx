    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navegación principal">
        ...
        <div className="lg:hidden">
          ...
          <div
            id="mobile-menu"
            className={`${mobileMenuOpen ? 'block' : 'hidden'} absolute top-full left-0 right-0 bg-white dark:bg-[#0b0f19] border-b border-slate-200 dark:border-slate-800/80 shadow-lg animate-slide-down py-4 px-4`}
            role="navigation"
          >
